...
class UpazilaSeeder extends Seeder
{
    ...
    public function run()
    {
        $upazilas = array(
            ...
            array('id' => '492','district_id' => '47','name' => 'Badda','bn_name' => 'বাড্ডা','url' => 'badda.dhaka.gov.bd'),
            array('id' => '493','district_id' => '47','name' => 'Adabor','bn_name' => 'আদাবর','url' => 'adabor.dhaka.gov.bd'),
            array('id' => '494','district_id' => '47','name' => 'Bangshal','bn_name' => 'বংশাল','url' => 'bangshal.dhaka.gov.bd'),
            array('id' => '495','district_id' => '47','name' => 'Biman Bandar','bn_name' => 'বিমান বন্দর','url' => 'bimanbandar.dhaka.gov.bd'),
            array('id' => '496','district_id' => '47','name' => 'Cantonment','bn_name' => 'ক্যান্টনমেন্ট','url' => 'cantonment.dhaka.gov.bd'),
            array('id' => '497','district_id' => '47','name' => 'Chawkbazar','bn_name' => 'চকবাজার','url' => 'chawkbazar.dhaka.gov.bd'),
            array('id' => '498','district_id' => '47','name' => 'Dakshinkhan','bn_name' => 'দক্ষিণখান','url' => 'dakshinkhan.dhaka.gov.bd'),
            array('id' => '499','district_id' => '47','name' => 'Darus Salam (Mirpur)','bn_name' => 'দার-উস-সালাম থানা','url' => 'darussalam.dhaka.gov.bd'),
            array('id' => '500','district_id' => '47','name' => 'Demra','bn_name' => 'ডেমরা','url' => 'demra.dhaka.gov.bd'),
            array('id' => '501','district_id' => '47','name' => 'Dhanmondi','bn_name' => 'ধানমন্ডি','url' => 'Dhanmondi.dhaka.gov.bd'),
            array('id' => '502','district_id' => '47','name' => 'Gendaria','bn_name' => 'গেন্ডারিয়া','url' => 'Gendaria.dhaka.gov.bd'),
            array('id' => '503','district_id' => '47','name' => 'Gulshan','bn_name' => 'গুলশান','url' => 'Gulshan.dhaka.gov.bd'),
            array('id' => '504','district_id' => '47','name' => 'Hazaribagh','bn_name' => 'হাজারীবাগ','url' => 'Hazaribagh.dhaka.gov.bd'),
            array('id' => '505','district_id' => '47','name' => 'Jatrabari','bn_name' => 'যাত্রাবাড়ি','url' => 'Jatrabari.dhaka.gov.bd'),
            array('id' => '506','district_id' => '47','name' => 'Kadamtali','bn_name' => 'কদমতলী','url' => 'Kadamtali.dhaka.gov.bd'),
            array('id' => '507','district_id' => '47','name' => 'Kafrul','bn_name' => 'কাফরুল','url' => 'kafrul.dhaka.gov.bd'),
            array('id' => '508','district_id' => '47','name' => 'Kalabagan','bn_name' => 'কলাবাগান','url' => 'Kalabagan.dhaka.gov.bd'),
            array('id' => '509','district_id' => '47','name' => 'Kamrangirchar','bn_name' => 'কামরাঙ্গিরচর','url' => 'Kamrangirchar.dhaka.gov.bd'),
            array('id' => '510','district_id' => '47','name' => 'Khilgaon','bn_name' => 'খিলগাঁও','url' => 'Khilgaon.dhaka.gov.bd'),
            array('id' => '511','district_id' => '47','name' => 'Khilkhet','bn_name' => 'খিলক্ষেত','url' => 'Khilkhet.dhaka.gov.bd'),
            array('id' => '512','district_id' => '47','name' => 'Kotwali','bn_name' => 'কোতোয়ালী থানা','url' => 'Kotwali.dhaka.gov.bd'),
            array('id' => '513','district_id' => '47','name' => 'Lalbagh','bn_name' => 'লালবাগ','url' => 'Lalbagh.dhaka.gov.bd'),
            array('id' => '514','district_id' => '47','name' => 'Mirpur','bn_name' => 'মিরপুর','url' => 'Mirpur.dhaka.gov.bd'),
            array('id' => '515','district_id' => '47','name' => 'Mohammadpur','bn_name' => 'মোহাম্মদপুর','url' => 'Mohammadpur.dhaka.gov.bd'),
            array('id' => '516','district_id' => '47','name' => 'Motijheel','bn_name' => 'মতিঝিল','url' => 'Motijheel.dhaka.gov.bd'),
            array('id' => '517','district_id' => '47','name' => 'New Market','bn_name' => 'নিউমার্কেট','url' => 'Newmarket.dhaka.gov.bd'),
            array('id' => '518','district_id' => '47','name' => 'Pallabi','bn_name' => 'পল্লবী','url' => 'Pallabi.dhaka.gov.bd'),
            array('id' => '519','district_id' => '47','name' => 'Paltan','bn_name' => 'পল্টন','url' => 'Paltan.dhaka.gov.bd'),
            array('id' => '520','district_id' => '47','name' => 'Ramna','bn_name' => 'রমনা','url' => 'Ramna.dhaka.gov.bd'),
            array('id' => '521','district_id' => '47','name' => 'Rampura','bn_name' => 'রামপুরা','url' => 'Rampura.dhaka.gov.bd'),
            array('id' => '522','district_id' => '47','name' => 'Sabujbagh','bn_name' => 'সবুজবাগ','url' => 'Sabujbagh.dhaka.gov.bd'),
            array('id' => '523','district_id' => '47','name' => 'Shahbagh','bn_name' => 'শাহবাগ','url' => 'Shahbagh.dhaka.gov.bd'),
            array('id' => '524','district_id' => '47','name' => 'Sher-e-Bangla Nagar','bn_name' => 'শেরেবাংলা নগর','url' => 'sherebanglanagar.dhaka.gov.bd'),
            array('id' => '525','district_id' => '47','name' => 'Shyampur','bn_name' => 'শ্যামপুর','url' => 'Shyampur.dhaka.gov.bd'),
            array('id' => '526','district_id' => '47','name' => 'Tejgaon','bn_name' => 'তেজগাঁও','url' => 'Tejgaon.dhaka.gov.bd'),
            array('id' => '527','district_id' => '47','name' => 'Turag','bn_name' => 'তুরাগ','url' => 'Turag.dhaka.gov.bd'),
            array('id' => '528','district_id' => '47','name' => 'Uttara','bn_name' => 'উত্তরা','url' => 'Uttara.dhaka.gov.bd'),
            array('id' => '529','district_id' => '47','name' => 'Uttar Khan','bn_name' => 'উত্তরা','url' => 'Uttarkhan.dhaka.gov.bd')
