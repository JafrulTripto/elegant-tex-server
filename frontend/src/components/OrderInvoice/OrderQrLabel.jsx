...
const st = StyleSheet.create({
  page: { paddingVertical: 12, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center' },
  meta: { marginLeft: 12, flex: 1 },
  id: { fontSize: 17, fontFamily: 'Helvetica-Bold' },
  party: { fontSize: 9, color: '#555555', marginTop: 3 },
