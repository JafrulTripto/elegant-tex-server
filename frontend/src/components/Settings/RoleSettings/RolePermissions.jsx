...
function RolePermissions({ role }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'value',
      key: 'value',
      render: (e, record) => <Switch loading={record.key === loadingSwithcKey && permissionLoading} disabled = {loadingSwithcKey || record.permission === 'PERMISSION_SETTINGS'} checked={record.value} onChange={(value) => onChange(record, value)} />
    },
