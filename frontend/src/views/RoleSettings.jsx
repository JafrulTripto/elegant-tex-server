...
import {Button, Card, Col, Form, Input, List, Modal, Row, Space, Typography} from "antd";
                             ...
                             actions={[
                               [
                                 ...
                                 <Button key="delete" type='text' size='small' danger
                                         onClick={() => handleDeleteRole(item)}>Delete</Button>
                               ]
                             ]}>
                    <Button onClick={() => assignUserRole(item.name)} type="link"
                            style={{color: colors.secondary}}>{item.name}</Button>
                  </List.Item>
                )}
              />
            </Card>
